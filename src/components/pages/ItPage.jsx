      ...
      <div className="it_container">
        <div className="it_background_header_image">
          <motion.div
            ...
            className="it_child_title_container"
            // initial={{ x: '100vw' }}
          ...
          >
            ...
            <p className="it_paragraph">
              თქვენი ბიზნესის უწყვეტ მუშაობაში ჩვენი გამოცდილი გუნდი
              დაგეხმარებათ. დღევანდელ რეალობაში ყველა მსხვილი თუ მცირე ბიზნესი
              დამოკიდებულია ელექტრონულ მოწყობილობებზე, მათმა ხარვეზით მუშაობამ
              კი შეიძლება პროცესები ძალიან შეაფერხოს, შესაბამისად საჭიროა მათი
              მუდმივი კონტროლი. ჩვენი გუნდი დაგეხმარებათ სწრაფად და მარტივად
              მოაგვაროთ მსგავსი ტიპის პრობლემები.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="it_card_container" ref={ref}>
        ...
        <motion.div
          ...
          className={`it_child_card_container ${
            isDarkmodeOn ? "it_card_dark" : "it_card_light"
          }`}
          initial={initial}
        ...
        >
          <img
            src={computer_service}
            alt="it service image"
            className="it_image_dard"
          />

          <div className="it_card_text_button">
            <p
              className={`it_catd_paragraph  ${
                isDarkmodeOn
                  ? "it_catd_paragraph_dark"
                  : "it_catd_paragraph_whit"
              }`}
            >
              კომპიუტერული სრული მომსახურება
            </p>
            <button
              onClick={() =>
                handleButtonClick("კომპიუტერული სრული მომსახურება")
              }
              className={`${
        ...
        >
          ...
          <div className="it_card_text_button">
            ...
            >
              ინტრნეტ კაბელების გაყვანა და ნებისმიერი მოწყობილობისთვის გაწერა
            </p>
            <button
              onClick={() =>
                handleButtonClick("hardware და sofrware მომსახურება")
              }
              className={`${
                isDarkmodeOn ? "contact_us_button" : "contact_us_button_dark"
              }`}
        ...
        >
          ...
          <div className="it_card_text_button">
            ...
            >
              კომპიუტერების და ნებისმიერი ელექტრონული მოწყობილობის დიაგნოსტიკა
              შეკეთება
            </p>
            <button
              onClick={() =>
                handleButtonClick("ელექტრონული მოწყობილობების დიაგნოსტიკა")
              }
              className={`${
                isDarkmodeOn ? "contact_us_button" : "contact_us_button_dark"
              }`}
        ...
        <div className="it_price_container">
          <motion.div
            ...
            onMouseLeave={mouseLeaveHandler}
            className={`${
              !isDarkmodeOn ? "it_child_price_dark" : "it_child_price"
            }`}
