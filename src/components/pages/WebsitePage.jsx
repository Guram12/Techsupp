      ...
      <div className="webservice_about_container" >
        ...
        >
          <div className="webservice_child_cont">
            ...
            <p className="webservice_header">ჩვენი გუნდი დაგეხმარებათ საიტის მაქსიმალურად მოკლე ვადაში შექმნაში.
              ...
              სირთულიდან გამომდინარე ხდება. თანხის გადახდა კი სამუშაოს დასრულების შემდეგ.</p>
          </div>
        </motion.div>
        <motion.img
        alt="website logo"
