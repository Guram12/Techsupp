    ...
    <div>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 24 150 28" preserveAspectRatio="none" style={{ height: '100px', width: '100%' }}>
        ...
        <g className="parallax">
          <use xlinkHref="#gentle-wave" x="50" y="3" fill="rgba(255,255,255,0.7)"></use>
          <use xlinkHref="#gentle-wave" x="50" y="0" fill="rgba(255,255,255,0.5)"></use>
          <use xlinkHref="#gentle-wave" x="50" y="9" fill="rgba(255,255,255,0.3)"></use>
