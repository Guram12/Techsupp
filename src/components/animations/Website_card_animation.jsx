  ...
  return (
    <div className="all_svg_cont">
      <div className="decode-text" ref={textRef}>
        ...
        <div className={`text-animation  ${isDarkmodeOn ? "animation_light_mode" : "animation_dark_mode"}`}>რ</div>
        <div className={`text-animation  ${isDarkmodeOn ? "animation_light_mode" : "animation_dark_mode"}`}>ჩ</div>
        <div className={`text-animation  ${isDarkmodeOn ? "animation_light_mode" : "animation_dark_mode"}`}>ი</div>
        <div className={`text-animation  ${isDarkmodeOn ? "animation_light_mode" : "animation_dark_mode"}`}>ე</div>

        <div className="space" />
        <div className={`text-animation  ${isDarkmodeOn ? "animation_light_mode" : "animation_dark_mode"}`}>შ</div>
        <div className={`text-animation  ${isDarkmodeOn ? "animation_light_mode" : "animation_dark_mode"}`}>ე</div>
        <div className={`text-animation  ${isDarkmodeOn ? "animation_light_mode" : "animation_dark_mode"}`}>ნ</div>
        <div className={`text-animation  ${isDarkmodeOn ? "animation_light_mode" : "animation_dark_mode"}`}>ი</div>
        <div className="space" />
        <div className={`text-animation  ${isDarkmodeOn ? "animation_light_mode" : "animation_dark_mode"}`}>ვ</div>
        <div className={`text-animation  ${isDarkmodeOn ? "animation_light_mode" : "animation_dark_mode"}`}>ე</div>
        <div className={`text-animation  ${isDarkmodeOn ? "animation_light_mode" : "animation_dark_mode"}`}>ბ</div>
        <div className={`text-animation  ${isDarkmodeOn ? "animation_light_mode" : "animation_dark_mode"}`}>ს</div>
        <div className={`text-animation  ${isDarkmodeOn ? "animation_light_mode" : "animation_dark_mode"}`}>ა</div>
        <div className={`text-animation  ${isDarkmodeOn ? "animation_light_mode" : "animation_dark_mode"}`}>ი</div>
